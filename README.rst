Python Client for Cloud Vision API
==================================

|stable| |pypi| |versions|

`Cloud Vision API`_: allows developers to easily integrate vision detection features within applications, including image labeling, face and landmark detection, optical character recognition (OCR), and tagging of explicit content.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-vision.svg
   :target: https://pypi.org/project/google-cloud-vision/
.. _Cloud Vision API: https://cloud.google.com/vision/docs/
...
.. _Enable the Cloud Vision API.:  https://cloud.google.com/vision/docs/
...
.. _Cloud Vision API Product documentation:  https://cloud.google.com/vision/docs/
