...
from google.cloud.vision_v1p1beta1.gapic.transports import image_annotator_grpc_transport
...
class ImageAnnotatorClient(object):
    ...
    def batch_annotate_images(
        ...
        Args:
            requests (list[Union[dict, ~google.cloud.vision_v1p1beta1.types.AnnotateImageRequest]]): Required. Individual image annotation requests for this batch.
