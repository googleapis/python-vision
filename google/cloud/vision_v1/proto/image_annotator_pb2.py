...
SafeSearchAnnotation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      violence_confidence:
          ...
          confident, 1 means very confident.
      racy_confidence:
          Confidence of racy_score. Range [0, 1]. 0 means not confident,
          1 means very confident.
      nsfw_confidence:
          Confidence of nsfw_score. Range [0, 1]. 0 means not confident,
          1 means very confident.
  """,
...
GcsDestination = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      uri:
          ...
          uri prefix you provide.  Examples:  -  File Prefix: gs
          ://bucket-name/here/filenameprefix The output files    will be
          created in gs://bucket-name/here/ and the names of the output
          files will begin with “filenameprefix”.  -  Directory Prefix:
          gs://bucket-name/some/location/ The output files    will be
          created in gs://bucket-name/some/location/ and the names of
          the output files could be anything because there was no
