...
# source: google/cloud/vision_v1p3beta1/proto/image_annotator.proto
...
from google.cloud.vision_v1p3beta1.proto import (
    product_search_pb2 as google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_product__search__pb2,
)
from google.cloud.vision_v1p3beta1.proto import (
    text_annotation_pb2 as google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_text__annotation__pb2,
)
from google.cloud.vision_v1p3beta1.proto import (
    web_detection_pb2 as google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_web__detection__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/vision_v1p3beta1/proto/image_annotator.proto",
    ...
    dependencies=[
        ...
        google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_product__search__pb2.DESCRIPTOR,
        google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_text__annotation__pb2.DESCRIPTOR,
        google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_web__detection__pb2.DESCRIPTOR,
...
_FEATURE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="max_results",
            full_name="google.cloud.vision.v1p3beta1.Feature.max_results",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="model",
            full_name="google.cloud.vision.v1p3beta1.Feature.model",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_IMAGESOURCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="gcs_image_uri",
            full_name="google.cloud.vision.v1p3beta1.ImageSource.gcs_image_uri",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="image_uri",
            full_name="google.cloud.vision.v1p3beta1.ImageSource.image_uri",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_IMAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="content",
            full_name="google.cloud.vision.v1p3beta1.Image.content",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="source",
            full_name="google.cloud.vision.v1p3beta1.Image.source",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FACEANNOTATION_LANDMARK = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="position",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.Landmark.position",
            index=1,
            number=4,
            type=11,
            cpp_type=10,
...
_FACEANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bounding_poly",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.bounding_poly",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.fd_bounding_poly",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="landmarks",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.landmarks",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="roll_angle",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.roll_angle",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="pan_angle",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.pan_angle",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="tilt_angle",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.tilt_angle",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.landmarking_confidence",
            index=7,
            number=8,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="joy_likelihood",
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.joy_likelihood",
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.sorrow_likelihood",
            index=9,
            number=10,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.anger_likelihood",
            index=10,
            number=11,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.surprise_likelihood",
            index=11,
            number=12,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.under_exposed_likelihood",
            index=12,
            number=13,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.blurred_likelihood",
            index=13,
            number=14,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.FaceAnnotation.headwear_likelihood",
            index=14,
            number=15,
            type=14,
            cpp_type=8,
...
_LOCATIONINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="lat_lng",
            full_name="google.cloud.vision.v1p3beta1.LocationInfo.lat_lng",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROPERTY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.vision.v1p3beta1.Property.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="google.cloud.vision.v1p3beta1.Property.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="uint64_value",
            full_name="google.cloud.vision.v1p3beta1.Property.uint64_value",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
_ENTITYANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="mid",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.mid",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="locale",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.locale",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="description",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.description",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="score",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.score",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="confidence",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.confidence",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="topicality",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.topicality",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="bounding_poly",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.bounding_poly",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="locations",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.locations",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="properties",
            full_name="google.cloud.vision.v1p3beta1.EntityAnnotation.properties",
            index=8,
            number=9,
            type=11,
            cpp_type=10,
...
_LOCALIZEDOBJECTANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="mid",
            full_name="google.cloud.vision.v1p3beta1.LocalizedObjectAnnotation.mid",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="language_code",
            full_name="google.cloud.vision.v1p3beta1.LocalizedObjectAnnotation.language_code",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.vision.v1p3beta1.LocalizedObjectAnnotation.name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="score",
            full_name="google.cloud.vision.v1p3beta1.LocalizedObjectAnnotation.score",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="bounding_poly",
            full_name="google.cloud.vision.v1p3beta1.LocalizedObjectAnnotation.bounding_poly",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_SAFESEARCHANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="adult",
            full_name="google.cloud.vision.v1p3beta1.SafeSearchAnnotation.adult",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="spoof",
            full_name="google.cloud.vision.v1p3beta1.SafeSearchAnnotation.spoof",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="medical",
            full_name="google.cloud.vision.v1p3beta1.SafeSearchAnnotation.medical",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="violence",
            full_name="google.cloud.vision.v1p3beta1.SafeSearchAnnotation.violence",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="racy",
            full_name="google.cloud.vision.v1p3beta1.SafeSearchAnnotation.racy",
            index=4,
            number=9,
            type=14,
            cpp_type=8,
...
_LATLONGRECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="min_lat_lng",
            full_name="google.cloud.vision.v1p3beta1.LatLongRect.min_lat_lng",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="max_lat_lng",
            full_name="google.cloud.vision.v1p3beta1.LatLongRect.max_lat_lng",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_COLORINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="color",
            full_name="google.cloud.vision.v1p3beta1.ColorInfo.color",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="score",
            full_name="google.cloud.vision.v1p3beta1.ColorInfo.score",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="pixel_fraction",
            full_name="google.cloud.vision.v1p3beta1.ColorInfo.pixel_fraction",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_DOMINANTCOLORSANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="colors",
            full_name="google.cloud.vision.v1p3beta1.DominantColorsAnnotation.colors",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_IMAGEPROPERTIES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.ImageProperties.dominant_colors",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CROPHINT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bounding_poly",
            full_name="google.cloud.vision.v1p3beta1.CropHint.bounding_poly",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="confidence",
            full_name="google.cloud.vision.v1p3beta1.CropHint.confidence",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.CropHint.importance_fraction",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_CROPHINTSANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="crop_hints",
            full_name="google.cloud.vision.v1p3beta1.CropHintsAnnotation.crop_hints",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CROPHINTSPARAMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="aspect_ratios",
            full_name="google.cloud.vision.v1p3beta1.CropHintsParams.aspect_ratios",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_WEBDETECTIONPARAMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.WebDetectionParams.include_geo_results",
            index=0,
            number=2,
            type=8,
            cpp_type=7,
...
_IMAGECONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="lat_long_rect",
            full_name="google.cloud.vision.v1p3beta1.ImageContext.lat_long_rect",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="language_hints",
            full_name="google.cloud.vision.v1p3beta1.ImageContext.language_hints",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.ImageContext.crop_hints_params",
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.ImageContext.product_search_params",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.ImageContext.web_detection_params",
            index=4,
            number=6,
            type=11,
            cpp_type=10,
...
_ANNOTATEIMAGEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="image",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageRequest.image",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageRequest.features",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="image_context",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageRequest.image_context",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_IMAGEANNOTATIONCONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="uri",
            full_name="google.cloud.vision.v1p3beta1.ImageAnnotationContext.uri",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="page_number",
            full_name="google.cloud.vision.v1p3beta1.ImageAnnotationContext.page_number",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_ANNOTATEIMAGERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.face_annotations",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.landmark_annotations",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.logo_annotations",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.label_annotations",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.localized_object_annotations",
            index=4,
            number=22,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.text_annotations",
            index=5,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.full_text_annotation",
            index=6,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.safe_search_annotation",
            index=7,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.image_properties_annotation",
            index=8,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.crop_hints_annotation",
            index=9,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="web_detection",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.web_detection",
            index=10,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.product_search_results",
            index=11,
            number=14,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="error",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.error",
            index=12,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="context",
            full_name="google.cloud.vision.v1p3beta1.AnnotateImageResponse.context",
            index=13,
            number=21,
            type=11,
            cpp_type=10,
...
_ANNOTATEFILERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="input_config",
            full_name="google.cloud.vision.v1p3beta1.AnnotateFileResponse.input_config",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="responses",
            full_name="google.cloud.vision.v1p3beta1.AnnotateFileResponse.responses",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_BATCHANNOTATEIMAGESREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="requests",
            full_name="google.cloud.vision.v1p3beta1.BatchAnnotateImagesRequest.requests",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_BATCHANNOTATEIMAGESRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="responses",
            full_name="google.cloud.vision.v1p3beta1.BatchAnnotateImagesResponse.responses",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ASYNCANNOTATEFILEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="input_config",
            full_name="google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.input_config",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.features",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="image_context",
            full_name="google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.image_context",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="output_config",
            full_name="google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest.output_config",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_ASYNCANNOTATEFILERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="output_config",
            full_name="google.cloud.vision.v1p3beta1.AsyncAnnotateFileResponse.output_config",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ASYNCBATCHANNOTATEFILESREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="requests",
            full_name="google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesRequest.requests",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ASYNCBATCHANNOTATEFILESRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="responses",
            full_name="google.cloud.vision.v1p3beta1.AsyncBatchAnnotateFilesResponse.responses",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_INPUTCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="gcs_source",
            full_name="google.cloud.vision.v1p3beta1.InputConfig.gcs_source",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="mime_type",
            full_name="google.cloud.vision.v1p3beta1.InputConfig.mime_type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_OUTPUTCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.vision.v1p3beta1.OutputConfig.gcs_destination",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="batch_size",
            full_name="google.cloud.vision.v1p3beta1.OutputConfig.batch_size",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_GCSSOURCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="uri",
            full_name="google.cloud.vision.v1p3beta1.GcsSource.uri",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_GCSDESTINATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="uri",
            full_name="google.cloud.vision.v1p3beta1.GcsDestination.uri",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_OPERATIONMETADATA = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="create_time",
            full_name="google.cloud.vision.v1p3beta1.OperationMetadata.create_time",
            index=1,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="update_time",
            full_name="google.cloud.vision.v1p3beta1.OperationMetadata.update_time",
            index=2,
            number=6,
            type=11,
            cpp_type=10,
...
_FACEANNOTATION_LANDMARK.fields_by_name[
    ...
    google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_geometry__pb2._POSITION
)
...
_IMAGECONTEXT.fields_by_name[
    ...
    google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_product__search__pb2._PRODUCTSEARCHPARAMS
)
...
_ANNOTATEIMAGERESPONSE.fields_by_name[
    ...
    google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_text__annotation__pb2._TEXTANNOTATION
)
_ANNOTATEIMAGERESPONSE.fields_by_name[
...
_ANNOTATEIMAGERESPONSE.fields_by_name[
    ...
    google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_web__detection__pb2._WEBDETECTION
)
_ANNOTATEIMAGERESPONSE.fields_by_name[
    "product_search_results"
].message_type = (
    google_dot_cloud_dot_vision__v1p3beta1_dot_proto_dot_product__search__pb2._PRODUCTSEARCHRESULTS
)
_ANNOTATEIMAGERESPONSE.fields_by_name[
    "error"
...
Feature = _reflection.GeneratedProtocolMessageType(
    ...
    {
        "DESCRIPTOR": _FEATURE,
        "__module__": "google.cloud.vision_v1p3beta1.proto.image_annotator_pb2",
...
ImageSource = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      image_uri:
          ...
          Storage Request    URIs <https://cloud.google.com/storage/docs
          /reference-uris>`__ for    more info.  2. A publicly-
          accessible image HTTP/HTTPS URL. When fetching images from
          HTTP/HTTPS URLs, Google cannot guarantee that the request will
          be    completed. Your request may fail if the specified host
          denies the    request (e.g. due to request throttling or DOS
          prevention), or if    Google throttles requests to the site
          for abuse prevention. You    should not depend on externally-
          hosted images for production    applications.  When both
...
EntityAnnotation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      mid:
          ...
          Knowledge Graph Search API <https://developers.google.com
          /knowledge-graph/>`__.
      locale:
...
OutputConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      batch_size:
          ...
          ``gcs_destination``.\ ``uri``.  Currently, batch_size only
...
_IMAGEANNOTATOR = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002\037"\032/v1p3beta1/images:annotate:\001*\332A\010requests',
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002("#/v1p3beta1/files:asyncBatchAnnotate:\001*\332A\010requests\312A4\n\037AsyncBatchAnnotateFilesResponse\022\021OperationMetadata',
        ),
    ],
)
