...
class Feature(proto.Message):
    ...
    Attributes:
        type (~.image_annotator.Feature.Type):
            The feature type.
        max_results (int):
...
class FaceAnnotation(proto.Message):
    ...
    class Landmark(proto.Message):
        ...
        Attributes:
            type (~.image_annotator.FaceAnnotation.Landmark.Type):
                Face landmark type.
        ...
        type = proto.Field(proto.ENUM, number=3, enum="FaceAnnotation.Landmark.Type",)
...
class ImageContext(proto.Message):
    ...
    Attributes:
        ...
        face_recognition_params (~.face.FaceRecognitionParams):
...
class AnnotateFileResponse(proto.Message):
    ...
    error = proto.Field(proto.MESSAGE, number=4, message=status.Status,)
