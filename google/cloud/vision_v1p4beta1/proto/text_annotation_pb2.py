...
_BLOCK.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision__v1p4beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_PARAGRAPH.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision__v1p4beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_WORD.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision__v1p4beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
_SYMBOL.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision__v1p4beta1_dot_proto_dot_geometry__pb2._BOUNDINGPOLY
...
TextAnnotation = _reflection.GeneratedProtocolMessageType('TextAnnotation', (_message.Message,), {
  ...
  v1p4beta1.TextAnnotation.TextProperty] message definition below for
  more detail.
