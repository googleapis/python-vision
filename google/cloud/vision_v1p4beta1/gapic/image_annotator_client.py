...
from google.cloud.vision_v1p4beta1.gapic.transports import image_annotator_grpc_transport
...
class ImageAnnotatorClient(object):
    ...
    def async_batch_annotate_images(
        ...
        if 'async_batch_annotate_images' not in self._inner_api_calls:
            self._inner_api_calls['async_batch_annotate_images'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.async_batch_annotate_images,
                default_retry=self._method_configs['AsyncBatchAnnotateImages'].retry,
                default_timeout=self._method_configs['AsyncBatchAnnotateImages'].timeout,
        ...
        operation = self._inner_api_calls['async_batch_annotate_images'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def batch_annotate_files(
        ...
        if 'batch_annotate_files' not in self._inner_api_calls:
            self._inner_api_calls['batch_annotate_files'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['batch_annotate_files'](request, retry=retry, timeout=timeout, metadata=metadata)
