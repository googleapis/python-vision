...
class ProductSearchClient(metaclass=ProductSearchClientMeta):
    ...
    def delete_product_set(self,
        ...
        .. code-block::
            ...
            def sample_delete_product_set():
                ...
                # Make the request
                response = client.delete_product_set(request=request)
    ...
    def delete_reference_image(self,
        ...
        .. code-block::
            ...
            def sample_delete_reference_image():
                ...
                # Make the request
                response = client.delete_reference_image(request=request)
    ...
    def add_product_to_product_set(self,
            request: Union[product_search_service.AddProductToProductSetRequest, dict] = None,
            *,
            name: str = None,
            product: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block::
            ...
            def sample_add_product_to_product_set():
                ...
                # Make the request
                response = client.add_product_to_product_set(request=request)
    ...
    def remove_product_from_product_set(self,
            request: Union[product_search_service.RemoveProductFromProductSetRequest, dict] = None,
            *,
            name: str = None,
            product: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block::
            ...
            def sample_remove_product_from_product_set():
                ...
                # Make the request
                response = client.remove_product_from_product_set(request=request)
    ...
    def list_products_in_product_set(self,
            request: Union[product_search_service.ListProductsInProductSetRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
