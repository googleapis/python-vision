...
from google.cloud.vision_v1p3beta1.types import text_annotation
...
class FaceAnnotation(proto.Message):
    ...
    Attributes:
        ...
        fd_bounding_poly (google.cloud.vision_v1p3beta1.types.BoundingPoly):
            ...
            prefix.
        landmarks (Sequence[google.cloud.vision_v1p3beta1.types.FaceAnnotation.Landmark]):
...
class EntityAnnotation(proto.Message):
    ...
    Attributes:
        ...
        properties (Sequence[google.cloud.vision_v1p3beta1.types.Property]):
...
class CropHintsAnnotation(proto.Message):
    ...
    Attributes:
        crop_hints (Sequence[google.cloud.vision_v1p3beta1.types.CropHint]):
            Crop hint results.
    """
