...
class WebDetection(proto.Message):
    ...
    class WebPage(proto.Message):
        ...
        full_matching_images = proto.RepeatedField(proto.MESSAGE, number=4,
            message='WebDetection.WebImage',
        )

        partial_matching_images = proto.RepeatedField(proto.MESSAGE, number=5,
            message='WebDetection.WebImage',
        )
    ...
    web_entities = proto.RepeatedField(proto.MESSAGE, number=1,
        message=WebEntity,
    )

    full_matching_images = proto.RepeatedField(proto.MESSAGE, number=2,
        message=WebImage,
    )

    partial_matching_images = proto.RepeatedField(proto.MESSAGE, number=3,
        message=WebImage,
    )

    pages_with_matching_images = proto.RepeatedField(proto.MESSAGE, number=4,
        message=WebPage,
    )

    visually_similar_images = proto.RepeatedField(proto.MESSAGE, number=6,
        message=WebImage,
    )

    best_guess_labels = proto.RepeatedField(proto.MESSAGE, number=8,
        message=WebLabel,
    )
