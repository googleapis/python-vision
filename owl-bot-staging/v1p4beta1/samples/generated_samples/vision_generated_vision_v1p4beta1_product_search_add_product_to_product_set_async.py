...
# [START vision_generated_vision_v1p4beta1_ProductSearch_AddProductToProductSet_async]
...
async def sample_add_product_to_product_set():
    ...
    # Make the request
    response = await client.add_product_to_product_set(request=request)


# [END vision_generated_vision_v1p4beta1_ProductSearch_AddProductToProductSet_async]
