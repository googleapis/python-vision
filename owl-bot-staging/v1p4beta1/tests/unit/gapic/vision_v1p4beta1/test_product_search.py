...
from google.cloud.vision_v1p4beta1.services.product_search.transports.base import _API_CORE_VERSION
from google.cloud.vision_v1p4beta1.services.product_search.transports.base import _GOOGLE_AUTH_VERSION
