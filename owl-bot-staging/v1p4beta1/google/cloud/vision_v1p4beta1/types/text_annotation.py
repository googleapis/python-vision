...
class Block(proto.Message):
    ...
    Attributes:
        ...
        paragraphs (Sequence[google.cloud.vision_v1p4beta1.types.Paragraph]):
    ...
    Attributes:
        ...
        bounding_box (google.cloud.vision_v1p4beta1.types.BoundingPoly):
            ...
            -  when it's rotated 180 degrees around the top-left corner
               ...
               still be (0, 1, 2, 3).
        words (Sequence[google.cloud.vision_v1p4beta1.types.Word]):
    ...
    Attributes:
        ...
        bounding_box (google.cloud.vision_v1p4beta1.types.BoundingPoly):
            ...
            -  when it's rotated 180 degrees around the top-left corner
               it becomes: 2----3 \| \| 1----0 and the vertex order will
               still be (0, 1, 2, 3).
        symbols (Sequence[google.cloud.vision_v1p4beta1.types.Symbol]):
