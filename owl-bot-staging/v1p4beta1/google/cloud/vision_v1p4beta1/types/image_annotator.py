...
from google.cloud.vision_v1p4beta1.types import text_annotation
...
class FaceAnnotation(proto.Message):
    ...
    Attributes:
        ...
        fd_bounding_poly (google.cloud.vision_v1p4beta1.types.BoundingPoly):
            ...
            prefix.
        landmarks (Sequence[google.cloud.vision_v1p4beta1.types.FaceAnnotation.Landmark]):
        ...
        headwear_likelihood (google.cloud.vision_v1p4beta1.types.Likelihood):
            Headwear likelihood.
        recognition_result (Sequence[google.cloud.vision_v1p4beta1.types.FaceRecognitionResult]):
    ...
    recognition_result = proto.RepeatedField(proto.MESSAGE, number=16,
...
class EntityAnnotation(proto.Message):
    ...
    Attributes:
        ...
        properties (Sequence[google.cloud.vision_v1p4beta1.types.Property]):
...
class DominantColorsAnnotation(proto.Message):
    ...
    Attributes:
        colors (Sequence[google.cloud.vision_v1p4beta1.types.ColorInfo]):
...
class CropHintsAnnotation(proto.Message):
    ...
    Attributes:
        crop_hints (Sequence[google.cloud.vision_v1p4beta1.types.CropHint]):
            Crop hint results.
    """
...
class ImageContext(proto.Message):
    ...
    face_recognition_params = proto.Field(proto.MESSAGE, number=10,
...
class AnnotateImageRequest(proto.Message):
    ...
    Attributes:
        ...
        features (Sequence[google.cloud.vision_v1p4beta1.types.Feature]):
            Requested features.
...
class AnnotateImageResponse(proto.Message):
    ...
    Attributes:
        face_annotations (Sequence[google.cloud.vision_v1p4beta1.types.FaceAnnotation]):
            If present, face detection has completed
            successfully.
        landmark_annotations (Sequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, landmark detection has completed
            successfully.
        logo_annotations (Sequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, logo detection has completed
            successfully.
        label_annotations (Sequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, label detection has completed
            successfully.
        localized_object_annotations (Sequence[google.cloud.vision_v1p4beta1.types.LocalizedObjectAnnotation]):
            If present, localized object detection has
            completed successfully. This will be sorted
            descending by confidence score.
        text_annotations (Sequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
...
class BatchAnnotateImagesResponse(proto.Message):
    ...
    Attributes:
        responses (Sequence[google.cloud.vision_v1p4beta1.types.AnnotateImageResponse]):
...
class BatchAnnotateFilesResponse(proto.Message):
    ...
    Attributes:
        responses (Sequence[google.cloud.vision_v1p4beta1.types.AnnotateFileResponse]):
