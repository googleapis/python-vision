...
class ImageAnnotatorRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_async_batch_annotate_files(self, request: image_annotator.AsyncBatchAnnotateFilesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[image_annotator.AsyncBatchAnnotateFilesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_async_batch_annotate_files(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_async_batch_annotate_images(self, request: image_annotator.AsyncBatchAnnotateImagesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[image_annotator.AsyncBatchAnnotateImagesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_async_batch_annotate_images(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_batch_annotate_files(self, request: image_annotator.BatchAnnotateFilesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[image_annotator.BatchAnnotateFilesRequest, Sequence[Tuple[str, str]]]:
