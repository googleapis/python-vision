...
class TextAnnotation(proto.Message):
    ...
    Attributes:
        pages (Sequence[google.cloud.vision_v1p2beta1.types.Page]):
...
class Page(proto.Message):
    ...
    Attributes:
        ...
        height (int):
            ...
            images (including TIFFs) the unit is pixels.
        blocks (Sequence[google.cloud.vision_v1p2beta1.types.Block]):
...
class Block(proto.Message):
    ...
    Attributes:
        ...
        paragraphs (Sequence[google.cloud.vision_v1p2beta1.types.Paragraph]):
...
class Paragraph(proto.Message):
    ...
    Attributes:
        ...
        words (Sequence[google.cloud.vision_v1p2beta1.types.Word]):
    ...
    Attributes:
        ...
        bounding_box (google.cloud.vision_v1p2beta1.types.BoundingPoly):
            ...
            -  when it's rotated 180 degrees around the top-left corner
               it becomes: 2----3 \| \| 1----0 and the vertice order
               will still be (0, 1, 2, 3).
        symbols (Sequence[google.cloud.vision_v1p2beta1.types.Symbol]):
