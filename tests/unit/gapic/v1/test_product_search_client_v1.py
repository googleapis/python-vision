...
class TestProductSearchClient(object):
    ...
    def test_import_product_sets(self):
        ...
        expected_response = {}
        expected_response = product_search_service_pb2.ImportProductSetsResponse(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_import_product_sets', done=True)
        ...
        expected_request = product_search_service_pb2.ImportProductSetsRequest(parent=parent, input_config=input_config)
    ...
    def test_import_product_sets_exception(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_import_product_sets_exception', done=True)
    ...
    def test_purge_products(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_purge_products', done=True)
        operation.response.Pack(expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.PurgeProductsRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_purge_products_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_purge_products_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_create_product_set(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.CreateProductSetRequest(parent=parent, product_set=product_set)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_product_sets(self):
        ...
        expected_response = product_search_service_pb2.ListProductSetsResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.ListProductSetsRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_product_set(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.UpdateProductSetRequest(product_set=product_set)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_product(self):
        ...
        expected_response = {'name': name, 'display_name': display_name, 'description': description, 'product_category': product_category}
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.CreateProductRequest(parent=parent, product=product)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_products(self):
        ...
        expected_response = product_search_service_pb2.ListProductsResponse(**expected_response)
    ...
    def test_get_product(self):
        ...
        description = 'description-1724546052'
        product_category = 'productCategory-1607451058'
        expected_response = {'name': name_2, 'display_name': display_name, 'description': description, 'product_category': product_category}
        expected_response = product_search_service_pb2.Product(**expected_response)
    ...
    def test_update_product(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.UpdateProductRequest(product=product)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_reference_image(self):
        ...
        expected_response = product_search_service_pb2.ReferenceImage(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.CreateReferenceImageRequest(parent=parent, reference_image=reference_image)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_reference_image(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.DeleteReferenceImageRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_reference_images(self):
        ...
        expected_response = {'page_size': page_size, 'next_page_token': next_page_token, 'reference_images': reference_images}
        expected_response = product_search_service_pb2.ListReferenceImagesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.ListReferenceImagesRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_reference_image(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.GetReferenceImageRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_add_product_to_product_set(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.AddProductToProductSetRequest(name=name, product=product)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_remove_product_from_product_set(self):
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.RemoveProductFromProductSetRequest(name=name, product=product)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_products_in_product_set(self):
        ...
        products = [products_element]
        expected_response = {'next_page_token': next_page_token, 'products': products}
        expected_response = product_search_service_pb2.ListProductsInProductSetResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = product_search_service_pb2.ListProductsInProductSetRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
